...
export const StickyHeaderPart: React.FC = () => {
  return (
    ...
    >
      <nav className='mx-0 flex items-center justify-between tracking-tight text-white md:w-full md:pl-4 md:pr-20 lg:max-w-[1200px] xl:mx-auto xl:w-full xl:px-2 xl:px-4'>
        {links?.map((item) => {
